...
function updateCountdown(){
  const target = new Date('2026-10-28T19:30:00-05:00').getTime();
...
const milestones = [
  ...
  {t:180, msg:'⏰ Faltan '+Math.ceil((new Date('2026-10-28T19:30:00-05:00')-new Date())/(1000*60*60*24))+' días para el evento'},
];
